...
<html lang="en">
    <head>
        ...
        <title>Admin Manage assemblies</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage assemblies</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Classes</li>
            							<li class="active">Manage assemblies</li>
            						</ul>
                                </div>
