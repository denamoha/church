...
$stmt21->execute();
                 ...
                 $cnt=1;
                  ...
                  {  ?>
<p><b>member Name :</b> <?php echo htmlentities($result->StudentName);?></p>
<p><b>member Roll Id :</b> <?php echo htmlentities($result->RollId);?>
<p><b>member assembly:</b> <?php echo htmlentities($result->ClassName);?>(<?php echo htmlentities($result->Section);?>)
<?php }
